...
export const DEFAULT_DATA: ResumeData = {
  ...
  about: {
    ...
    details: `Possède 3 années d'expérience en développement d'applications web dans des équipes Agile, maitrise des normes de design et polyvalent sur différents topics: devops, AI, data... Très familier avec le developemment Vue.js/Nuxt et polyvalent sur de nombreux languages backend. Habitué à évoluer en autonomie sur des verticales parfois complexes et apte à communiquer avec le client pour comprendre et résoudre ses besoins techniques.`
  },
  experiences: [
    {
      ...
      place: 'France',
      skills: ['Rust', 'TypeScript', 'Redis', 'Postgres', 'Grafana', 'Terraform', 'RabbitMQ', 'Nomad'].slice(0, 6),
      bullets: [
    ...
    },
    {
      ...
      place: 'Manchester, UK',
      skills: ['Typescript', 'Laravel', 'Sentry', 'Next.js', 'MySQL', 'Mixpanel'].slice(0, 5),
      bullets: [
    ...
    },
    {
      ...
      place: 'France, Paris',
      skills: ['React', 'TypeScript', 'Node.js', 'Kubernetes', 'Postgres', 'Sentry', 'Azure', 'Grafana',],
      bullets: [
