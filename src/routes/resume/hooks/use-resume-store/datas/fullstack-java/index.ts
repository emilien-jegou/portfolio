...
export const DEFAULT_DATA: ResumeData = {
  ...
  about: {
    ...
    details: `Possède 3 années d'expérience en développement d'applications web, de la chouche infra a l'application React, capable d'intégrer rapidement de nouveaux concepts et paradigmes. Habitué à évoluer en autonomie sur des verticales parfois complexes et apte à communiquer avec le client pour comprendre et résoudre ses besoins techniques. Bonnes maitrise des normes de design et polyvalent sur différents topics: devops, AI, data...`
  },
  experiences: [
    {
    ...
    },
    {
      ...
      place: 'Manchester, UK',
      skills: ['Laravel', 'Typescript', 'Sentry', 'Next.js', 'MySQL', 'Mixpanel'].slice(0, 5),
      bullets: [
