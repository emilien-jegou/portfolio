...
export const DEFAULT_DATA: ResumeData = {
  ...
  about: {
    ...
    details: `Possède 3 années d'expérience en développement d'applications web, spécialisé en développement **Laravel/TypeScript**, capable d'intégrer rapidement de nouveaux concepts et paradigmes. Habitué à évoluer en autonomie sur des verticales parfois complexes et apte à communiquer avec le client pour comprendre et résoudre ses besoins techniques.`
  },
  experiences: [
    {
