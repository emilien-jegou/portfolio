...
A common criticism of class-based programming is its tendency toward over-engineering. Converting class-heavy code to more functional approaches frequently results in significant code reduction, in essence it is a much more minimal approach to programming.
...
explained by the highly codified practices developers have to follow
...
required, *through focused refactoring*.

A "just-in-time" development strategy keeps codebases cleaner, simpler, and more maintainable rather than cluttering them with speculative functionality e.g.:
...
early 2000s but with the advent of LSP and types systems refactoring has never
