    ...
    <>
      {isRemoved.value === false && (
        ...
        >
          ...
          <button
            type="button"
            class="absolute right-1 top-1 rounded-onwo-s-sm p-1 text-contrast opacity-70 transition-opacity focus:opacity-100 focus:outline-none focus:ring-1"
            onClick$={() => {
              isOpen.value = false;
            }}
          >
